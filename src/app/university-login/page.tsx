...
import { UniversityLoginService } from "../service/university-service";
...
const UniversityLoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await UniversityLoginService(email, password);
      toast.success("Login successful! Redirecting to dashboard...", { autoClose: 2000 });
      setTimeout(() => router.push("/university"), 2000);
    } catch (error: any) {
      ...
      <div className="w-full max-w-4xl mx-4 flex bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-purple-600 to-indigo-600 items-center justify-center p-10 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <img src="/university_registration.svg" alt="University" className="w-full max-w-xs mx-auto drop-shadow-2xl" />
            <h2 className="text-white text-2xl font-bold mt-6">University Portal</h2>
            <p className="text-purple-200 text-sm mt-2">Empower your institution with world-class e-learning.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-2">University Sign In</h2>
            <p className="text-gray-500 text-sm mt-1">Access your university dashboard</p>
          </div>
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            ...
            <a href="/university-registration" className="text-purple-600 font-semibold hover:underline">
              Register your university
            </a>
          </p>

          <div className="mt-4 text-center">
            <a href="/user-login" className="text-gray-400 text-xs hover:text-gray-600 transition">
