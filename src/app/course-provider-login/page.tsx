      ...
      <div className="w-full max-w-4xl mx-4 flex bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-purple-600 to-indigo-600 items-center justify-center p-10 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <img src="/course_provider.svg" alt="Course Provider" className="w-full max-w-xs mx-auto drop-shadow-2xl" />
            <h2 className="text-white text-2xl font-bold mt-6">Course Provider Portal</h2>
            <p className="text-purple-200 text-sm mt-2">Manage your courses and track student progress.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-2">Course Provider Sign In</h2>
            <p className="text-gray-500 text-sm mt-1">Access your provider dashboard</p>
          </div>
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            ...
            <a href="/course-provider-registration" className="text-purple-600 font-semibold hover:underline">
