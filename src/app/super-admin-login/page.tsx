...
import { SuperAdminLoginService } from "../service/super-admin.service";
...
export default function SuperAdminLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await SuperAdminLoginService(email, password);
            toast.success("Welcome, Admin! Redirecting to dashboard...", { autoClose: 2000 });
            setTimeout(() => router.push("/super-admin/dashboard"), 2000);
        } catch (error: any) {
            ...
            <div className="w-full max-w-4xl mx-4 flex bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="hidden md:flex w-1/2 bg-gradient-to-br from-purple-600 to-indigo-600 items-center justify-center p-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center">
                        <img src="/login_all.svg" alt="Admin Login" className="w-full max-w-xs mx-auto drop-shadow-2xl" />
                        <h2 className="text-white text-2xl font-bold mt-6">Admin Portal</h2>
                        <p className="text-purple-200 text-sm mt-2">Manage and oversee the entire Eduverse platform.</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <div className="mb-8">
                        ...
                        <h2 className="text-xl font-bold text-gray-900 mt-2">Super Admin Sign In</h2>
                    ...
                    <div className="mt-6 text-center">
                        <a href="/" className="text-gray-400 text-xs hover:text-gray-600 transition">
                            ← Back to Eduverse
                        </a>
                    </div>
                </div>
