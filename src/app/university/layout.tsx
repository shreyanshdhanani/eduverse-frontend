...
import { Home, List, Settings, BookOpen, CreditCard, ArrowLeftFromLine, ListPlus, LogOut, Menu, X } from "lucide-react";
import Link from "next/link";

const menuItems = [
  { id: "dashboard", title: "Dashboard", icon: <Home size={20} />, href: "/university/dashboard" },
  { id: "courses", title: "Courses", icon: <BookOpen size={20} />, href: "/university/courses" },
  { id: "enrolled-student", title: "Enrolled Students", icon: <ListPlus size={20} />, href: "/university/enrolled-student" },
  { id: "students", title: "Students", icon: <List size={20} />, href: "/university/students" },
  { id: "subscription", title: "Subscription", icon: <CreditCard size={20} />, href: "/university/subscription" },
  { id: "settings", title: "Settings", icon: <Settings size={20} />, href: "/university/settings" },
];

export default function UniversityLayout({ children }: any) {
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-purple-600 font-medium uppercase tracking-wider mt-0.5">University Portal</p>
          </div>
        </div>
      </div>
